...
// --- ASSEMBLY: Add all sections to MAIN ---
main.appendChild(createHeroSection().element);
main.appendChild(createPhilosophySection().element);
main.appendChild(createDishesSection().element);
main.appendChild(createBookingSection().element);
main.appendChild(createInstaSection().element);
